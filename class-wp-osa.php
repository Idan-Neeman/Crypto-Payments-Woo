	...
	class WP_OSA
	{
		...
		function admin_menu()
		{
			add_menu_page(
				...
				'Crypto Payments Woo',                        // Menu Title - lower corner of admin menu
		...
		{
			echo '<div class="wrap">';
			echo '<h1>Crypto Payments Woo <span style="font-size:50%;">v' . WCP_VERSION . '</span></h1>';
			if (!class_exists('woocommerce')) {
				echo '<div class="notice notice-error is-dismissible"><p>This plugin requires the WooCommerce plugin to be installed and active!</p></div>';
				echo '</div>';
				return;
			}
		...
		public function btc_gateway_page()
		{
			echo '<div class="wrap">';
			echo '<h1>Crypto Payments Woo <span style="font-size:50%;">v' . WCP_VERSION . '</span></h1>';
			if (!class_exists('woocommerce')) {
			...
			header("Location: admin.php?page=wc-settings&tab=checkout&section=bitcoin_btc");
		}

		public function fair_gateway_page()
		{
			echo '<div class="wrap">';
			echo '<h1>Crypto Payments Woo <span style="font-size:50%;">v' . WCP_VERSION . '</span></h1>';
			if (!class_exists('woocommerce')) {
			...
			header("Location: admin.php?page=wc-settings&tab=checkout&section=faircoin_fair");
		}
