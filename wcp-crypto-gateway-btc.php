	...
	public function default_payment_instructions() {
		$payment_instructions = '
            <table style="word-break: inherit;" id="wcp-payment-instructions-table">
              <tr>
                <td colspan="2">' . __( 'Please send your Bitcoin BTC payment as follows:', 'woocommerce' ) . '</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>
                  <div style="padding:2px 0px;">
                    <a href="{{{BITCOINS_PAY_URL}}}"><img src="https://api.qrserver.com/v1/create-qr-code/?color=000000&amp;bgcolor=FFFFFF&amp;data=bitcoin%3A{{{BITCOINS_ADDRESS}}}%3Famount%3D{{{BITCOINS_AMOUNT}}}%26message%3D{{{PAYMENT_MESSAGE_URL_SAFE}}}&amp;qzone=1&amp;margin=0&amp;size=180x180&amp;ecc=L" style="vertical-align:middle;border:1px solid #888;" /></a>
                  </div>
                </td>
              </tr>
            </table>
            ...
            <ol>
                ...
                <li>' . __( 'We are not responsible for lost funds if you send anything other than BTC', 'woocommerce' ) . '</li>
